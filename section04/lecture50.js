...
console.log('myHT: ', myHT.get('Dean'));
// myHT:  deanmachine@gmail.com
console.log('myHT: ', myHT.get('Megan'));
// myHT:  megansmith@gmail.com
console.log('myHT: ', myHT.get('Dane'));
// myHT:  dane1010@outlook.com
